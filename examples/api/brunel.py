...
def argparser():
    ...
    parser.add_argument('--order', type=int, default=10,
                        help=("The scale of the network (full "
                              "network order=1000)"))
    ...
    parser.add_argument('--num_record', type=int, default=50,
                        help=("The number of cells in each population to "
                              "record. All cells will be recorded if "
                              "num_record > len(population)."))
    parser.add_argument('--num_record_v', type=int, default=0,
                        help=("The number of cells in each population to "
                              "record the voltage from"))
    ...
    parser.add_argument('--plot_input', action='store_true',
                        help=("Plots the external Poisson input in addition to"
                              " the excitatory and inhibitory cells"))
    ...
    parser.add_argument('--progress_bar', action='store_true', default=False,
                        help=("Show a progress bar for the simulation time "
                              "(Can cause difficulties in some displays)"))
