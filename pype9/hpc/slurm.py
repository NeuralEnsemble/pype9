...
#SBATCH --output={logging_path}                                                                                                                                          
#SBATCH --error={logging_path}

# Slurm does not use queues in the same sense as sge: Name of the queue
# $ -q {que_name}
...
# Warning a new input parameter for partition may be required.
#
...
# The modules framework below is supposed to replace paths 
...
"""
    ...
    def _submit_to_que(self, jobscript_path):
        sub_text = subprocess.check_output{}'sbatch {}'.format(jobscript_path),
            shell=True)
        print sub_text
