...
echo ''
echo python $WORK_DIR/src/test/performance.py --method ninemlp --build compile_only
echo ''
python $WORK_DIR/src/test/performance.py --method ninemlp --build compile_only
